            ...
            if (state is ScheduleTimelineState) {
              ...
              if (state.update == false){
                ...
                BlocProvider.of<ScheduleBloc>(context).add(ScheduleChangeEvent());
                 ...
                 if(state.currentState is ScheduleTimelineState){
                BlocProvider.of<ScheduleBloc>(context).add(ScheduleTimelineEvent());
              }
              else{
                BlocProvider.of<ScheduleBloc>(context).add(ScheduleTableEvent());
              }
              }
