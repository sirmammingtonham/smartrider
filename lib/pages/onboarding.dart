                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Center(
                              child: Image(
                                image:
                                    AssetImage("assets/app_icons/logo_v2.png"),
                                height: 300.0,
                                width: 300.0,
                              ),
                            ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(
                              child: Text(
                                  'Switch between live bus/shuttle routes and set reminders for upcoming arrivals.',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: Color(0xFF181c5b),
                                    fontSize: 16.0,
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(
                                child: Text(
                                    'Quickly request a vehicle to transport you safely around the campus (7 p.m - 12 a.m).',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Color(0xFF181c5b),
                                      fontSize: 16.0,
